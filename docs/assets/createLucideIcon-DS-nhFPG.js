import{av as l}from"./index-BzgG7oFT.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const k=({name:t,iconNode:e,absoluteStrokeWidth:o,"absolute-stroke-width":r,strokeWidth:n,"stroke-width":u,size:s=i.width,color:h=i.stroke,...a},{slots:c})=>l("svg",{...i,...a,width:s,height:s,stroke:h,"stroke-width":d(o)||d(r)||o===!0||r===!0?Number(n||u||i["stroke-width"])*24/Number(s):n||u||i["stroke-width"],class:p("lucide",a.class,...t?[`lucide-${w(C(t))}-icon`,`lucide-${w(t)}`]:["lucide-icon"]),...!c.default&&!m(a)&&{"aria-hidden":"true"}},[...e.map(f=>l(...f)),...c.default?[c.default()]:[]]);/**
 * @license lucide-vue-next v1.0.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
